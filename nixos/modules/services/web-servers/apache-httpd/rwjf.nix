...
let
  ...
  mainCfg = config.services.rwjf-httpd;
  ...
  extraForeignModules = [{ name = "dispatcher"; path = pkgs.dispatcher_mod; }];
  ...
  in ''
    ...
    ServerAdmin rwjf-devs@velir.com
...

{
  ...
  config = mkIf config.services.rwjf-httpd.enable {
